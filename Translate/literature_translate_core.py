...
DEFAULT_GLOSSARY_PACK: dict[str, dict[str, object]] = {
    "00_general_academic.csv": {
        ...
        "terms": [
            ...
            ("methodology", "方法学"), ("case study", "案例研究"), ("comparative analysis", "比较分析"),
            ("ablation study", "消融研究"), ("limitations", "局限性"), ("future work", "未来工作"),
        ],
    },
    "01_ai_ml_data_science.csv": {
        ...
        "terms": [
            ...
            ("transformer", "Transformer"), ("attention mechanism", "注意力机制"), ("neural network", "神经网络"),
            ("self-supervised learning", "自监督学习"), ("reinforcement learning", "强化学习"), ("data mining", "数据挖掘"),
        ],
    },
    "02_catalysis_chemistry_materials.csv": {
        ...
        "terms": [
            ...
            ("nanoparticle", "纳米颗粒"), ("thin film", "薄膜"), ("crystal structure", "晶体结构"),
            ("thermal stability", "热稳定性"), ("electrochemical impedance spectroscopy", "电化学阻抗谱"),
        ],
    },
