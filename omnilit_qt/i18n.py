...
TEXTS: dict[str, tuple[str, str]] = {
    ...
    "pdf_parse_mode_mineru": ("深度 fallback：MinerU", "Deep fallback: MinerU"),
    "pdf_parse_mode_hybrid": ("混合解析：PaddleOCR-VL + MinerU fallback", "Hybrid parse: PaddleOCR-VL + MinerU fallback"),
...
RU_TEXTS.update({
    ...
    "pdf_parse_mode_mineru": "Deep fallback: MinerU",
    "pdf_parse_mode_hybrid": "Hybrid parse: PaddleOCR-VL + MinerU fallback",
